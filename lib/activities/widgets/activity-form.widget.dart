...
import 'package:youniversity_app/activities/view_models/activity-data-class.model.dart';
...
class ActivityFormState extends State<ActivityForm> {
  ...
  final List<String> _coursesList = ['Base de Datos', 'IHC y Tecnologías Móviles'];
